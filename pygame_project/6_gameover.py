...
import os
from os import closerange, pardir
import pygame
from pygame import encode_file_path, image
...
balls.append({
    ...
    "to_x": 3,  # x축 이동방향, -3 이면 오른쪽으로,3이면 오른쪽으로
    "to_y": -6,  # y축 이동방향,
...
#  # 3. 게임 캐릭터 위치 정의
    ...
    # 무기 위치 조정
    # 100, 200 -> 180, 160, 140 ,... (x좌표 그대로,y좌표는 위로(-스피드))
